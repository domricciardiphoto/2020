// Name: PaperFlyer JS
// Version: paperflyer-v.10-2-BF RC Black Friday Colors
// Paired CSS: paperflyer-v9-v1-min.css
// Version Notes: (v9.7.1) addresses modal scroll motion lock & has decoupled link assets
...
$(".fsi_wrapper").scroll(function () {
    ...
    $('.menu_item').css('background-color', '#000'),
...
window.addEventListener("DOMContentLoaded", function () {   
    ! function (e) {
 $('.header2').after('<div id="clockcontainer-BF" style="float:left; margin-left:1.2%;margin-top:0.9%"><div class="main_container-d"> <div id="b1" class="whitebox"></div><div class="clock_dots">:</div><div id="b2" class="whitebox"></div><div class="clock_dots">:</div><div id="b3" class="whitebox"></div></div></div>');


        function sizer() {
    if ($(window).width() < 769) {$("#clockcontainer-BF").css('min-height' ,  $('#clockcontainer-BF').width() - ($('#clockcontainer-BF').width() * .42))}else {}
    $('#clockcontainer-BF').fadeIn()
}

        e(window).width() < 721 ?  e("#clockcontainer-BF").css("background-image", "url(" + mobile_url + ")") : e("#clockcontainer-BF").css("background-image", "url(" + desktop_img + ")"), e(window).resize(function () {
            e(window).width() < 721 ? e("#clockcontainer-BF").css("background-image", "url(" + mobile_url + ")").css('min-height' , $('#clockcontainer-BF').width() - ($('#clockcontainer-BF').width() * .42)-5) : e("#clockcontainer-BF").css("background-image", "url(" + desktop_img + ")").css('min-height' , $('#clockcontainer-BF').width() - ($('#clockcontainer-BF').width() * .91)+3)
