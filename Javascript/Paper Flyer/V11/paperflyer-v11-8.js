...
window.addEventListener('DOMContentLoaded', function() {
    var load = '';
    var pagestoload=[load0,load1,load2,load3,load4,load5,load6,load7,load8,load9,load10,load11,load12,load13,load14,load15,load16,load17,load18,load19,load20,load21,load22,load23];
