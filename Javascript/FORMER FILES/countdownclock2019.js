...
$('#clockcontainer').wrap('<a title="'+alt_and_title+'" alt="'+alt_and_title+'" href="'+url+'"></a>')
        ...
        function sizer() {
    if ($(window).width() < 769) {$("#clockcontainer").css('min-height' ,  document.width - (document.width * .42))}else {}
    $('#clockcontainer').fadeIn()
        ...
        e("#url-cc").attr("href", url), e("#url-cc").attr("alt", alt_and_title), e("#url-cc").attr("title", alt_and_title), e(window).width() < 721 ?  e("#clockcontainer").css("background-image", "url(" + mobile_url + ")") : e("#clockcontainer").css("background-image", "url(" + desktop_img + ")"), e(window).resize(function () {
            e(window).width() < 721 ? e("#clockcontainer").css("background-image", "url(" + mobile_url + ")").css('min-height' , document.width - (document.width * .42)) : e("#clockcontainer").css("background-image", "url(" + desktop_img + ")").css('min-height' , document.width - (document.width * .91))
        ...
        var t = new Date(livedate).getTime(),
            n = setInterval(function () {
                ...
                document.getElementById("b3").innerHTML = i + '<div class="wh">Hours</div>', document.getElementById("b2").innerHTML = o + '<div class="wh">Minutes</div>', document.getElementById("b1").innerHTML = c + '<div class="wh">Seconds</div>', a < 0 && (clearInterval(n), document.getElementById("clock2019").innerHTML = "EXPIRED")
            }, 1e3)
