...
function xmlParser(xml) {
    ...
    if (Bose_Box === '1') {
        $('#store_features').append('<a class="noblue" title="Shop All Bose"  href="' + Bose_Box_link + '"><div id="Bose" class="feature_box"><div class="feature_image"><img style="width:100%" itemprop="image" src="/images/promos/bose-store-box-150x150-d.jpg"/></div><div class="feature_description"><div  class="description_title"><h3>Bose</h3></div><div class="description_info">' +  Bose_Box_text + '</div></div><div class="cfmi">Shop All Bose</div></div></a>');
    }
