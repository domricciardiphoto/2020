...
function xmlParser(xml) {
    ...
    if (appliance_block0 === '1') {
        $('#store_features').append('<a class="noblue"  title="Shop All Kitchen Appliances" href="' + appliance_block0_link + '"><div id="appliances" class="feature_box"><div  class="feature_image"><img  itemprop="image" style="width:100%" src="/images/promos/Kitchen-Appliances-Catagory-150x150-d.jpg"/></div><div class="feature_description"><div   class="description_title"><h3>Kitchen Appliances</h3></div><div  class="description_info">' + appliances_text + '</div></div><div class="cfmi">Shop All Kitchen Appliances</div></div></a><a class="noblue"  title="Shop All Washers & Dryers" href="' + laundry_block0_link + '"><div id="appliances" class="feature_box"><div  class="feature_image"><img  itemprop="image" style="width:100%" src="/images/promos/Washers-Dryers-Catagory-150x150-d.jpg"/></div><div class="feature_description"><div   class="description_title"><h3>Washers &amp; Dryers</h3></div><div  class="description_info">' + laundry_text + '</div></div><div class="cfmi">Shop All Washers &amp; Dryers</div></div></a>');
    }
    ...
    if (Bose_Box === '1') {
        $('#store_features').append('<a class="noblue" title="Shop All Bose"  href="' + Bose_Box_link + '"><div id="Bose" class="feature_box"><div class="feature_image"><img style="width:100%" itemprop="image" src="/images/promos/bose-standard-box-150x150-d.jpg"/></div><div class="feature_description"><div  class="description_title"><h3>Bose</h3></div><div class="description_info">' +  Bose_Box_text + '</div></div><div class="cfmi">Shop All Bose</div></div></a>');
    }

    if (Bose_Experience === '1') {
        $('#store_features').append('<a class="noblue" title="Shop All Bose"  href="' + Bose_Experience_link + '"><div id="Bose" class="feature_box"><div class="feature_image"><img style="width:100%" itemprop="image" src="/images/promos/bose-store-box-150x150-d.jpg"/></div><div class="feature_description"><div  class="description_title"><h3>The Bose Experience</h3></div><div class="description_info">' +  Bose_Experience_text + '</div></div><div class="cfmi">Shop All Bose</div></div></a>');
    }
    ...
    if (JBL_Box === '1') {
        $('#store_features').append('<a class="noblue"  title="Shop All JBL"  href="' + JBL_Box_link + '"><div id="JBL" style="margin-top:0px" class="feature_box"><div  class="feature_image"><img style="width:100%" itemprop="image" src="/images/promos/jbl-store-box-150x150-d.jpg"/></div><div class="feature_description"><div  class="description_title"><h3>JBL</h3></div><div  class="description_info">' + JBL_Box_text + '</div></div><div class="cfmi">Shop All JBL</div></div></a>');
    }
...
/*
    if (patio_block0 === '1') {
        $('#store_features').append('<a class="noblue" title="Shop All Patio Furniture"  href="' + patio_block0_link + '"><div id="Patio_Furniture" class="feature_box"><div  class="feature_image"><img itemprop="image" style="width:100%" src="/images/promos/PCR-patiofurniture-150x150.jpg"/></div><div class="feature_description"><div  class="description_title"><h3><h3>Patio Furniture</h3></div><div   class="description_info">' + patio_text + '</div></div><div class="cfmi">Shop All Patio Furniture</div></div></a>');
    }
    ...
    */
    ...
    if (Sonos_Box === '1') {
        $('#store_features').append('<a class="noblue" title="Shop All Sonos"  href="' + Sonos_Box_link + '"><div id="Sonos" class="feature_box"><div  class="feature_image"><img itemprop="image" style="width:100%" src="/images/promos/sonos-store-box-150x150-d.jpg"/></div><div class="feature_description"><div  class="description_title"><h3><h3>Sonos</h3></div><div class="description_info">' + Sonos_Box_text + '</div></div><div class="cfmi">Shop All Sonos</div></div></a>');
    }


    if (Viper_block0 === '1') {
        $('#store_features').append('<a class="noblue" title="Shop All Sonos"  href="' + Viper_block0_link + '"><div id="Sonos" class="feature_box"><div  class="feature_image"><img itemprop="image" style="width:100%" src="/images/promos/viper-products-catagory-2018.jpg"/></div><div class="feature_description"><div  class="description_title"><h3><h3>Viper Car Alarms &amp; Remote Starts</h3></div><div   class="description_info">' + Viper_text + '</div></div><div class="cfmi">Shop All Viper Car Alarms &amp; Remote Starts</div></div></a>');
    }



    if (Yamaha_Box === '1') {
        $('#store_features').append('<a class="noblue" title="Shop All Yamaha"  href="' + Yamaha_Box_link + '"><div id="Yamaha" class="feature_box"><div  class="feature_image"><img itemprop="image" style="width:100%" src="/images/promos/yamaha-store-box-150x150-d.jpg"/></div><div class="feature_description"><div  class="description_title"><h3><h3>Yamaha</h3></div><div   class="description_info">' + Yamaha_Box_text + '</div></div><div class="cfmi">Shop All Yamaha</div></div></a>');
    }
    ...
    if (UconnAthletics === '1') {
        ...
        $('#store_features').after().append('<style type="text/css">.uconn_center{width:65%;float:left;text-align:center;margin-left:5%}.uconn_center_img_con{width:25%;float:left}.uconn_center_img1{width:40%;margin-right:12%;margin-left:6%;float:left;margin-top:2%}.uconn_center_img2{width:40%;float:left;margin-top:2%}.mhide{display:block}.store_titles h2.uconn-h2{font-size:1.6em;line-height:30px;padding-top:26px}@media (max-width:768px){.store_titles h2.uconn-h2{font-size:1.4em;line-height:25px;padding-top:0}}@media (max-width:767px){.mhide{display:none}.store_titles h2.uconn-h2{font-size:.875em;line-height:25px;padding:0}.uconn_center{margin-left:0}.uconn_center_img_con{width:25%;float:left;margin-left:5%;margin-top:3%}}</style><div class="content_100" style="border:none"><div class="uconn_center"><div class="store_titles"><h2 class="uconn-h2">P.C. Richard &amp; Son is a proud partner of<br class="mhide">UConn Athletics and the Sports Center of Connecticut</h2></div></div><div class="uconn_center_img_con"><img class="uconn_center_img1" alt="UConn Athletics Logo" title="UConn Athletics Logo" src="/images/promos/HuskyUConn_Athletics_2019.jpg"> <img class="uconn_center_img2" alt="Sports Center of Connecticut Logo" title="Sports Center of Connecticut Logo" src="/images/promos/sc-color-final-2019.jpg"></div></div>');
...
$('ul.breadcrumbs>li:nth-child(1)').html('<li><a title="Stores" href="/storelocator/store-landing.jsp" class="ico">Stores</a></li><li><a title="State" href="/storelocator/store-landing.jsp" class="ico">');
