window.addEventListener('DOMContentLoaded', function () {
    $('#reviews').attr('data-bv-productId' , 'PCR0'+store_number) 
    ...
    $('head').append('<meta http-equiv="cache-control" content="max-age=0"><meta http-equiv="cache-control" content="no-cache"><meta http-equiv="expires" content="-1"><meta http-equiv="expires" content="Tue, 01 Jan 1980 11:00:00 GMT"><meta http-equiv="pragma" content="no-cache">');
       ...
       store_zip2 = $('h2').children('span[itemprop=postalCode]').text()
       ...
       function xmlParser(xml) {
           ...
           //$('.wrapper-d').prepend('<meta itemprop="openingHours" content="Mo ' + meta_open_mon + ':00-' + (meta_close_mon + 12) + ':00"/><meta itemprop="openingHours" content="Tu ' + meta_open_tues + ':00-' + (meta_close_tues + 12) + ':00"/><meta itemprop="openingHours" content="We ' + meta_open_wed + ':00-' + (meta_close_wed +12) + ':00"/><meta itemprop="openingHours" content="Th ' + meta_open_thurs + ':00-' + (meta_close_thurs + 12) + ':00"/><meta itemprop="openingHours" content="Fr ' + meta_open_fri + ':00-' + (meta_close_fri + 12) + ':00' +'"/><meta itemprop="openingHours" content="Sa ' + meta_open_sat + ':00-' + (meta_close_sat +12) + ':00' + '"/><meta itemprop="openingHours" content="Su ' + meta_open_sun + ':00-' + ( meta_close_sun + 12) + ':00' + '"/>');



           $('#meta0').attr('content' , 'Mo ' + meta_open_mon + ':00-' + (meta_close_mon + 12) + ':00');
           $('#meta1').attr('content' , 'Tu ' + meta_open_tues + ':00-' + (meta_close_tues + 12) + ':00');
           $('#meta2').attr('content' , 'We ' + meta_open_wed + ':00-' + (meta_close_wed + 12) + ':00');
           $('#meta3').attr('content' , 'Th ' + meta_open_thurs + ':00-' + (meta_close_thurs + 12) + ':00');
           $('#meta4').attr('content' , 'Fr ' + meta_open_fri + ':00-' + (meta_close_fri + 12) + ':00');
           $('#meta5').attr('content' , 'Sa ' + meta_open_sat + ':00-' + (meta_close_sat + 12) + ':00');
           $('#meta6').attr('content' , 'Su ' + meta_open_sun + ':00-' + (meta_close_sun + 12) + ':00');


   
           if (meta_open_sun === 'Closed') {
               $('#meta6').attr('content', 'Su Closed');
           }
           if (meta_open_sat === 'Closed') {
               $('#meta5').attr('content', 'Sa Closed');
           }
           if (meta_open_fri === 'Closed') {
               $('#meta4').attr('content', 'Fr Closed');
           }
           if (meta_open_thurs === 'Closed') {
               $('#meta3').attr('content', 'Th Closed');
           }
           if (meta_open_wed === 'Closed') {
               $('#meta2').attr('content', 'We Closed');
           }
           if (meta_open_tues === 'Closed') {
               $('#meta1').attr('content', 'Tu Closed');
           }
           if (meta_open_mon === 'Closed') {
               $('#meta0').attr('content', 'Mo Closed');
           }
